...
export default function App() {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    .catch(Response => {
      setPopup(true)
      setText(Response.response.data.Message)
      setSucess(Response.response.data.Sucess)
      setCode(Response.response.data.Status)
      setTimeout(() => {
        setPopup(false)
      }, 10000);
    });
  ...
  return (
    <div className="flex flex-1 justify-center bg-[#444]">
      <form className="h-screen flex flex-col justify-center mx-auto" onSubmit={handleSubmit}>
