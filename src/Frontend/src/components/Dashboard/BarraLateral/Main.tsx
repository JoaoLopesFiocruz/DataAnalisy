...
export default function Main({ user, page = 0 }: MainProps) {
  return (
    <div className="flex  flex-col w-[280px] h-screen bg-[#191919] items-center py-[48px] px-[28px]" >
      ...
      <div className="px-[16px] gap-[16px] flex flex-col w-[224px] h-[432px] text-500 font-inter text-[16px] list-none mb-[228px]">
      ...
      <button className="w-[224px] h-[48px] bg-[#FFFFFF14] border-none px-[16px] py-[12px] flex">
